...
export default function About() {
  ...
  const paragraphs = [
    ...
    'Now that I have explained exactly nothing about the subject matter of this blog, here\'s a little about me: I am currently an undergrad at Columbia University in New York.  In my free time, I like to play trumpet, piano, and guitar, rock climb, hike, travel, play soccer, hang out with friends, and eat fried rice (not always at the same time).',
