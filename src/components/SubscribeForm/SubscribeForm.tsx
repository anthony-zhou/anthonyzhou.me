...
export default function SubscribeForm() {
  ...
  return (
    <div className={`py-2 pb-10 md:pb-2 md:sticky md:bottom-0 md:flex justify-center bg-white z-50 md:shadow-[0_-3px_10px_0_rgba(0,0,0,0.0785)] transition-opacity ${formVisible ? 'opacity-100' : 'opacity-0'}`}>
        ...
        >
          <div className="mc-field-group">
            <input
              ...
              required
            />
            <input type="submit" value="Subscribe" name="subscribe" className="p-1 bg-[#1D8A50] text-white text-sm" />
          </div>
        </form>
      </div>
    </div>
